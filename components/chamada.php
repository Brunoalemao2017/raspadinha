                    ...
                    <div class="raspinha-card" data-category="dinheiro">
                        <div class="card-banner">
                            <?php if ($raspinha['banner'] && file_exists($_SERVER['DOCUMENT_ROOT'] . $raspinha['banner'])): ?>
                                <img src="<?= htmlspecialchars($raspinha['banner']) ?>"
                                    alt="<?= htmlspecialchars($raspinha['nome']) ?>" class="banner-image">
                            <?php else: ?>
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-description">
                                <?= htmlspecialchars($raspinha['descricao'] ?: 'Raspe e ganhe prêmios incríveis!') ?></p>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/raspadinhas/show.php?id=<?= $raspinha['id'] ?>&play=1" class="play-btn">
                                    Jogar
                                </a>
                            </div>
                        </div>
