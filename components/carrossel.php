            ...
            <?php if (!empty($banners)): ?>
                <div class="carousel-wrapper">
                    <?php foreach ($banners as $index => $banner): ?>
                        ...
                        $bannerUrl = htmlspecialchars($banner['banner_img']);
                        $cacheBuster = '?v=' . time();
                        ?>
                        <div class="hero-slide banner-slide <?= $index === 0 ? 'active' : '' ?>" data-slide="<?= $index ?>"
                            style="background-image: url('<?= $bannerUrl . $cacheBuster ?>');">
                ...
                <?php if (count($banners) > 1): ?>
                    ...
                    <div class="carousel-indicators">
                        <?php foreach ($banners as $index => $banner): ?>
                            <button class="indicator <?= $index === 0 ? 'active' : '' ?>" onclick="goToSlide(<?= $index ?>)"
