...
<head>
    ...
    <style>
        ...
        .stat-card.indicados::before { background: #fed000; }
        ...
        .stat-icon.indicados { background: rgba(34, 197, 94, 0.2); color: #fed000; }
...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('%c💰 Programa de Afiliados carregado!', 'color: #fed000; font-size: 16px; font-weight: bold;');
