    ...
    <style>
        * {
        ...
        .form-container::before {
            ...
            width: 100%;
            height: 4px;
            background: linear-gradient(90deg, #fed000, #fed000, #22c55e);
            opacity: 0;
            transition: opacity 0.3s ease;
        }
...
<body>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="nome_site"
                                    value="<?= htmlspecialchars($config['nome_site'] ?? '') ?>" class="form-input"
                                    placeholder="Digite o nome do seu site" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-input-container">
                                    <input type="file" name="logo" accept="image/jpeg, image/png" id="logo-upload"
                                        class="file-input">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="deposito_min"
                                    value="<?= htmlspecialchars($config['deposito_min'] ?? '0') ?>" class="form-input"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="saque_min"
                                    value="<?= htmlspecialchars($config['saque_min'] ?? '0') ?>" class="form-input"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="cpa_padrao"
                                    value="<?= htmlspecialchars($config['cpa_padrao'] ?? '0') ?>" class="form-input"
                                    placeholder="Ex: 5,00" required>
                                <p style="color: #6b7280; font-size: 0.8rem; margin-top: 0.5rem;">
                                    <i class="fas fa-info-circle"></i>
                                    Comissão por porcentagem paga por cada novo cadastro indicado
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-container">
                                    <input type="text" name="revshare_padrao"
                                        value="<?= htmlspecialchars($config['revshare_padrao'] ?? '0') ?>"
                                        class="form-input percentage" placeholder="Ex: 10,00" required>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('%c⚙️ Configurações do Sistema carregadas!', 'color: #fed000; font-size: 16px; font-weight: bold;');
