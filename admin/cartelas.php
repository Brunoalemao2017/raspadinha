    ...
    <style>
        * {
        ...
        .mini-stat-card::before {
            ...
            width: 100%;
            height: 3px;
            background: linear-gradient(90deg, #fed000, #fed000);
            opacity: 0;
            transition: opacity 0.3s ease;
        }
...
<body>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome"
                                value="<?= $raspadinha_edit ? htmlspecialchars($raspadinha_edit['nome']) : '' ?>"
                                class="form-input" placeholder="Digite o nome da raspadinha..." required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descricao" class="form-input" rows="3"
                                ...
                                required><?= $raspadinha_edit ? htmlspecialchars($raspadinha_edit['descricao']) : '' ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="valor"
                                value="<?= $raspadinha_edit ? htmlspecialchars($raspadinha_edit['valor']) : '' ?>"
                        ...
                        <button type="submit"
                            name="<?= $raspadinha_edit ? 'editar_raspadinha' : 'adicionar_raspadinha' ?>"
                            class="form-button">
                                ...
                                <div class="raspadinha-card">
                                    <div class="raspadinha-header">
                                        <div class="flex-1">
                                            ...
                                            <p class="raspadinha-description"><?= htmlspecialchars($raspadinha['descricao']) ?>
                                            </p>
                                        </div>
                                        <?php if ($raspadinha['banner']): ?>
                                            <img src="<?= htmlspecialchars($raspadinha['banner']) ?>" alt="Banner"
                                                class="raspadinha-banner">
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        <a href="?excluir_raspadinha&id=<?= $raspadinha['id'] ?>"
                                            onclick="return confirm('Tem certeza que deseja excluir esta raspadinha e todos os seus prêmios?')"
                    ...
                    <section class="form-section">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nome"
                                    value="<?= $premio_edit ? htmlspecialchars($premio_edit['nome']) : '' ?>"
                                    class="form-input" placeholder="Digite o nome do prêmio..." required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="valor"
                                    value="<?= $premio_edit ? htmlspecialchars($premio_edit['valor']) : '' ?>"
                                    class="form-input" placeholder="0,00" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="probabilidade"
                                    value="<?= $premio_edit ? htmlspecialchars($premio_edit['probabilidade']) : '' ?>"
                                    class="form-input" placeholder="5.00" required>
                            </div>
                                ...
                                <?php foreach ($premios as $premio): ?>
                                    <div class="prize-card">
                                        ...
                                        <div class="prize-actions">
                                            <a href="?raspadinha_id=<?= $_GET['raspadinha_id'] ?>&editar_premio&id=<?= $premio['id'] ?>"
                                                class="prize-action-btn prize-edit-btn">
                                                <i class="fas fa-edit"></i>
                                                Editar
                                            </a>
                                            <a href="?raspadinha_id=<?= $_GET['raspadinha_id'] ?>&excluir_premio&id=<?= $premio['id'] ?>"
                                                onclick="return confirm('Tem certeza que deseja excluir este prêmio?')"
                                                class="prize-action-btn prize-delete-btn">
                                                <i class="fas fa-trash"></i>
                                                Excluir
                                            </a>
                                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('%c🎯 Raspadinhas carregadas!', 'color: #fed000; font-size: 16px; font-weight: bold;');
