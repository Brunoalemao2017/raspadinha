...
<body>
                            ...
                            <div class="user-card">
                                ...
                                <div class="user-info">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span>Indicado por:
                                            <?= $usuario['email_indicador'] ? htmlspecialchars($usuario['email_indicador']) : 'Ninguém' ?></span>
                                    </div>
                                </div>

                                <div class="action-buttons">
                                    <button
                                        onclick="abrirModalEditarSaldo('<?= $usuario['id'] ?>', '<?= number_format($usuario['saldo'], 2, '.', '') ?>')"
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formEditarSaldo">
                ...
                <div>
                    ...
                    <input type="text" name="saldo" id="usuarioSaldo" class="modal-input" placeholder="0,00" required>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('%c👥 Gerenciamento de Usuários carregado!', 'color: #fed000; font-size: 16px; font-weight: bold;');
