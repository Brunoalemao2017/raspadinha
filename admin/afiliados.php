                    ...
                    <tr>
                        <td>
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #fed000, #fed000); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 0.8rem;">
                        ...
                        <td style="font-weight: 600; color: #fed000;">R$ ${formatarMoeda(indicado.total_depositado)}</td>
                        <td>
                            <span style="background: rgba(34, 197, 94, 0.1); color: #fed000; padding: 0.25rem 0.5rem; border-radius: 6px; font-size: 0.8rem; font-weight: 600;">
            ...
            historico.forEach(item => {
                ...
                html += `
                    <tr>
                        ...
                        <td style="font-weight: 700; color: #fed000;">R$ ${formatarMoeda(item.valor_comissao)}</td>
            ...
            historico.forEach(item => {
                ...
                html += `
                    <tr>
                        ...
                        <td style="font-weight: 700; color: #fed000;">R$ ${formatarMoeda(item.valor_revshare)}</td>
                        <td style="color: #9ca3af;">${dataFormatada}</td>
                    </tr>
                `;
            });
